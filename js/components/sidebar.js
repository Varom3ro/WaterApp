  ...
  return `
    <aside class="sidebar">
      <div class="sidebar-logo">
        ...
        <h1>Tu Empresa <span style="font-size: 11px; color: #888; font-weight: normal; margin-left: 4px; padding: 2px 6px; background: #eee; border-radius: 10px;" id="app-version">v2.2</span></h1>
      </div>
